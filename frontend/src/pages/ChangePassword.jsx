        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input className="input-field" type="password" value={form.current_password}
              ...
              required placeholder="Tu contraseña actual" autoFocus />
          </div>
          ...
          {success && (
            <div style={{background:'#0f2a1a',border:'1px solid #4ade80',borderRadius:8,padding:'12px 16px',color:'#4ade80',fontSize:14,marginBottom:8}}>
              {success}
            </div>
          )}
          ...
          <button type="button" className="btn-ghost login-btn" onClick={() => navigate(-1)}>
            Volver
          </button>
        </form>
      </div>
